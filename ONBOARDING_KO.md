...
AI가 학년, 문제 수, 난이도, 조작 방식과 교사용 정답지를 보여 줍니다. 원하는 조건과 다르면 생성 전에 바꿔 달라고 말합니다. 문제 수가 4개면 한 문제짜리 새 캔버스 4개를 만듭니다.
...
완료되면 MathCanvas 전용 Chrome에 첫 번째 편집 화면이 열리고, 대화에는 전체 편집 URL이 문제 순서대로 표시됩니다. 기존 캔버스는 바뀌지 않습니다.
