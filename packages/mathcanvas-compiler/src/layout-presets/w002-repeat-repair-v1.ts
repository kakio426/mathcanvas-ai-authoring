 ...
 *
 * The repair phase must keep twelve move-once source pieces, two rule slots,
 * four continuation targets, and three repair roles visible simultaneously.
 * Every semantic surface reserves 188px for the released SM02PB variants.
 */
