...
export const wave17MultiplicationArrayLayoutPreset: LayoutPreset = {
  ...
  tokens: {
    ...
    "item.array-panel": { scope: "item", x: 120, y: 125, width: 1320, height: 315 },
    "item.group-label": { scope: "item", x: 170, y: 155, width: 420, height: 44 },
    "item.array-text": { scope: "item", x: 170, y: 245, width: 1220, height: 100 },
    ...
    "item.pool-label": { scope: "item", x: centeredRowLeft(choiceCenterX, 3, 190, 18) + 20, y: 209, width: 280, height: 34 },
    ...centeredChoicePoolTokens({ roles: choices, rowCounts: [3, 2], centerX: choiceCenterX, firstRowY: 255, rowGap: 8, memberWidth: 190, memberHeight: 70, contentWidth: 150, columnGap: 18, insetX: 8, insetY: 6 }),
