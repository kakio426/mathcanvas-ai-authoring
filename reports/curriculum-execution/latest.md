...
- 현재 검토된 target: **10개 · offline 2 · live 2**
...
| 1 | 공통 ProblemFamily 기반 | complete | 32 canonical / 21 released |
| 2 | 학년군×영역 대표 격자 | in-progress | 1/12 pipeline-proven |
| 3A | 121개 AssessmentTargetSet 완전 분해 | in-progress | 4/121 |
| 3B | 필수 target family·offline 검증 | in-progress | 2/10 reviewed targets; global denominator incomplete |
| 3C | 현재 해시 live create·저장·재열기 | in-progress | 2/10 reviewed targets; global denominator incomplete |
| 4 | 전 범위 TeacherRequest·반영 표·실제 미리보기 | queued-after-phase-2 | 6/32 common-parameter families |
...
| 12 | 2 | [2수04-02] | 1-2 | 자료와 가능성 | 연결 target의 offline 검증 완료 | data.early-table.organize-v1 |
| 13 | 2 | [2수02-02] | 1-2 | 변화와 관계 | 연결 target의 offline 검증 완료 | pattern.create-repeat-unit-explain-v1 |
