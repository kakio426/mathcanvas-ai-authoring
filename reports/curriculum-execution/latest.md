...
- 현재 검토된 target: **10개 · offline 9 · live 2**
...
| 3B | 필수 target family·offline 검증 | in-progress | 9/10 reviewed targets; global denominator incomplete |
...
| 13 | 2 | [2수02-02] | 1-2 | 변화와 관계 | 현재 해시 canary·저장·재열기 | pattern.create-repeat-unit-explain-v1 |
