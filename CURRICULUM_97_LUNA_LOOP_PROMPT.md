...
8. 해당 standard의 공식 fixture, assessment-target module, domain family index
9. `docs/PROBLEM_FAMILY_ARCHITECTURE.md`
10. 사용할 native affordance의 catalog·rubric·release evidence
...
7. `LIVE_EVIDENCE` — 명시적으로 승인된 create-only canary·조작·저장·재열기
8. `BATCH_CLOSEOUT` — 해당 batch의 보고서·회귀·증거만 마감
...
- 모든 gate가 통과했을 때만 한 work item을 한 atomic commit으로 만든다.
...
```json
{
  ...
  "push": null,
  "blocker": null,
  "nextRequiredOperation": "LEARNING_MAP_BINDING"
}
```
